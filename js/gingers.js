  function makeGingers(data){
    w1_percent = data["w1_percent"]
    w2_percent = data["w2_percent"]
    w1_color = data["w1_color"]
    w2_color = data["w2_color"]
    w1_maindiv = data["w1_maindiv"]
    w2_maindiv = data["w2_maindiv"]
    w1_label = data["w1_label"]
    w2_label = data["w2_label"]
    w1_gradient = data["w1_gradientid"]
    w2_gradient = data["w2_gradientid"]

    buildSVG(w1_maindiv, w1_label, w1_color, w1_percent, w1_gradient)
    buildSVG(w2_maindiv, w2_label, w2_color, w2_percent, w2_gradient)
  }
  ...
  //       w1_maindiv: "#black_w1",
  //       w2_maindiv: "#black_w2",
  //       w1_label: "black_w1_label",
  //       w2_label:"black_w2_label",
  ...
  //       w1_maindiv: "#api_w1",
  //       w2_maindiv: "#api_w2",
  //       w1_label: "api_w1_label",
  //       w2_label:"api_w2_label",
  ...
  //       w1_maindiv: "#white_w1",
  //       w2_maindiv: "#white_w2",
  //       w1_label: "white_w1_label",
  //       w2_label:"white_w2_label",
  ...
  //       w1_color: "#f05856",
  //       w2_color: "#f05856",
  //       w1_maindiv: "#latino_w1",
  //       w2_maindiv: "#latino_w2",
  //       w1_label: "latino_w1_label",
  //       w2_label:"latino_w2_label",
  ...
  //       w1_maindiv: "#other_w1",
  //       w2_maindiv: "#other_w2",
  //       w1_label: "other_w1_label",
  //       w2_label:"other_w2_label",
  ...
  //     if (this.value === 'black'){
  //       makeGingers(allData[0])
  //     } else if (this.value === 'api'){
  //       makeGingers(allData[1])
  //     } else if (this.value === 'white'){
  //       makeGingers(allData[2])
  //     } else if (this.value === "latino"){
  //       makeGingers(allData[3])
  //     } else{
  //       makeGingers(allData[4])
  //     }
